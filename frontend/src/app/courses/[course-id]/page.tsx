...
export default function Course() {
  ...
  useEffect(() => {
    async function fetchData() {
      const course = await axios.get(`${process.env.NEXT_PUBLIC_API_URL}/api/courses/${courseId}`);
      setCourseTitle(course.data.language);
      const totalProblems = await axios.get(`${process.env.NEXT_PUBLIC_API_URL}/api/problems-count/${courseId}`, { headers });
